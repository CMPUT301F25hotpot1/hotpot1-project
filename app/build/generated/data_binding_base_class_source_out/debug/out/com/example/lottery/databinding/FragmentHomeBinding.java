...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnFilter,
      @NonNull MaterialButton btnScan, @NonNull TextInputEditText etSearch,
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeBinding((LinearLayout) rootView, btnFilter, btnScan, etSearch,
          rvEvents);
    }
